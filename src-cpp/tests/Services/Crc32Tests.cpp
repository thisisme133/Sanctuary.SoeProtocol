...
{
protected:
    static constexpr uint32_t SEED = 1858192374;

    static constexpr std::array<uint8_t, 512> DATA = {
...
TEST_F(Crc32Tests, Hash_IsCorrect)
{
    constexpr uint32_t hash = 3893349547;
    EXPECT_EQ(hash, GetCrc().Hash(DATA));
}
